...
<html lang="en" dir="ltr">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link px-4" href="#hygieneSection">Hygiene</a>
            </li>
            <li class="nav-item">
              <a class="nav-link px-4" href="#reviewsSection">Reviews</a>
            </li>
            <li class="nav-item">
      ...
      <div class="container">
        ...
        <div class="menuDiv">
          ...
          <div
            ...
            class="menu-section dynamic-menu-section"
            data-category-key="<?php echo htmlspecialchars($categoryId); ?>"
          >
    ...
    <div id="momos" class="menu-section legacy-menu-section" data-category-key="momos">
      ...
      <div class="eatSure container">
          ...
          <div id="chinese" class="menu-section legacy-menu-section" data-category-key="chinese">
            <div class="row menuHeading">
              <div class="col-12">
                <h1>Chinese</h1>
              </div>
          ...
          <div id="beverages" class="menu-section legacy-menu-section" data-category-key="beverages">
            <div class="row menuHeading">
              <div class="col-12">
                <h1>Beverages</h1>
              </div>
    ...
    <section id="reviewsSection" class="testimonials">
      <h1 class="hygiene-title">
